export const messages = {
    uz: {
        ...
        sendPhotoAsPhoto: 'Iltimos, rasmni "Foto" sifatida yuboring ("Fayl" emas), so\'ng "Tayyor" tugmasini bosing.',
        providePhone: 'Iltimos, telefon raqamingizni yuboring.',
        askPrice: 'Bir video uchun narxingiz qancha? (so\'mda)',
        priceInvalid: 'Iltimos, to\'g\'ri raqam kiriting.',
        askSocials: 'Ijtimoiy tarmoqlar havolalarini yuboring (Instagram, TikTok va h.k.) yoki pastdagi "O\'tkazib yuborish" tugmasini bosing.',
    ...
    ru: {
        ...
        sendPhotoAsPhoto: 'Пожалуйста, отправьте как фото (не как "Файл"), затем нажмите "Готово".',
        providePhone: 'Пожалуйста, укажите номер телефона.',
        askPrice: 'Какова ваша цена за видео? (в сумах)',
        priceInvalid: 'Пожалуйста, введите корректное число.',
        askSocials: 'Поделитесь ссылками на соцсети (Instagram, TikTok и т.д.) или нажмите кнопку "Пропустить" ниже.',
        skip: 'Пропустить',
    ...
    en: {
        ...
        sendPhotoAsPhoto: 'Please send as a photo (not as "File"), then click "Done".',
        providePhone: 'Please provide a phone number.',
        askPrice: 'What is your price per video? (in UZS)',
        priceInvalid: 'Please enter a valid number.',
        askSocials: 'Share your social links (Instagram, TikTok, etc.) or press the "Skip" button below.',
        skip: 'Skip',
